...
import { toggleClass } from "../../PureFunctions/pureFunctions";

const HotelItem = ({ hotel, withImg = false, isFav }) => {
  ...
  const favClass = isFav ? "isFavorite__active" : "";
  ...
  return (
    <div className={classNameItem}>
      ...
      <div className="content__hotel">
        <HotelTitle name={hotelName} />
        <HotelDateInfo />
        <HotelInfo price={Math.round(priceFrom)} />
      </div>
    </div>
  );
};
